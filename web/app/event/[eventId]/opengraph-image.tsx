...
export const alt = "Event OG Image";
export const size = {
  width: 1200,
  height: 630,
};
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <h1 tw="text-8xl" style={{ color: "#fff", margin: "0px 40px 0px 50px" }}>
          {event.title}
        </h1>

        <p tw="text-4xl" style={{ color: "#eee", margin: "30px 40px 0px 55px" }}>
          {event.caption}
        </p>
        <svg
          style={{
